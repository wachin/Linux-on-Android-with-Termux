...
Antes de seguir, si ustedes no van a usar git, no lean las partes de este tutorial en las que se explican uso, y configuraciones de git, pero si lo quieren instalar aunque no lo vayan a usar, lo que pasa es que para mí es una manera de verificar que puedan instalar otros programas de terminal en Termux.
...
- Usar la terminal
- Si no tiene cuidado al editar un archivo el repositorio se puede dañar.

#### Como evitar que mi repositorio se dañe al editar un archivo

Cuando edites un archivo de un repositorio que hayas clonado en el Almacenamiento Interno:
...
### Archivos usables
Se pueden usar archivos para control de versiones como: .txt, .md, o otros.
...
Busque "Termux", instálelo. Ellos tienen a la fecha que se me perdió mi Xiaomi 2024 la versión Termux 0.119, instálelo y ábralo.
...
>Nota: En la versión 0.119 de ellos no es necesario usar `pkg upgrade` porque `pkg update` es una especie de híbrido que hace las dos cosas
...
y presione Enter y acepte. Así lo he usado en un Redmi Xiaomi Note 11 que trae Termux 0.119 (versión que solo ellos tienen hasta esta fecha en que hago el tutorial 2024). 
...
Si la letra de Termux es muy pequeña, hágalo más grande usando los dos dedos haciendo zoom hacia afuera, y luego corrija lo que había dentro.
